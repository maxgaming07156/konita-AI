  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="mx-auto mt-16 flex w-full max-w-2xl flex-col gap-5 text-left font-sans">
      ...
      <motion.div variants={item} className="ml-11 w-11/12 max-w-[436px] sm:ml-12">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/[0.08] p-4 shadow-[0_8px_32px_rgba(59,130,246,0.1)] backdrop-blur-xl">
          <div className="flex items-center gap-2">
            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-500/30 text-blue-300">
          ...
          <p className="mt-2 text-sm leading-relaxed text-blue-100/80">
            Using <strong className="font-semibold text-blue-100">podr&iacute;as</strong> (could you) instead of <em className="italic text-blue-200/70">puedes</em> (can you) makes the request more polite.
          </p>
        </div>
      </motion.div>
      ...
      <motion.div variants={item} className="mx-auto mt-2">
        ...
        >
          <CheckCircle2 className="h-4 w-4 text-amber-400" aria-hidden="true" />
      ...
      <motion.div variants={item} className="mt-2 w-11/12 max-w-[480px]">
        <div className="flex gap-3 sm:gap-4">
          <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-500/20 text-purple-400 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
          ...
          <div className="flex-1 rounded-3xl rounded-tl-md border border-purple-500/20 bg-purple-500/[0.06] p-4 shadow-[0_8px_32px_rgba(168,85,247,0.08)] backdrop-blur-xl sm:p-5">
            ...
            <p className="mt-2 text-[15px] leading-relaxed text-purple-50">
            ...
            <div className="mt-4 flex w-fit cursor-pointer items-center gap-2 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-1.5 text-sm text-purple-200 transition-colors hover:bg-purple-500/20">
